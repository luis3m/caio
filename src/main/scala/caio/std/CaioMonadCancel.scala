...
abstract class CaioMonadCancel[C, V, L: Monoid] extends CaioMonadError[C, V, L] with MonadCancel[Caio[C, V, L, *], Throwable] {
...
object CaioMonadCancel {
  def apply[C, V, L: Monoid]: CaioMonadCancel[C, V, L] =
